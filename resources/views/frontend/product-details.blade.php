                                                ...
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        ...
                                                        <div class="product-img w-full h-full aspect-[3/4]">
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/3-1.png') }}" alt="img" />
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/3-2.png') }}" alt="img" />
                                                        </div>
                                            ...
                                            <div class="product-item grid-type" data-item="4">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        ...
                                                        <div class="product-img w-full h-full aspect-[3/4]">
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/4-1.png') }}" alt="img" />
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/4-2.png') }}" alt="img" />
                                                        </div>
                                                        <div class="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
                                                            <div class="quick-view-btn w-full text-button-uppercase py-2 text-center rounded-full duration-300 bg-white hover:bg-black hover:text-white">Quick View</div>
                                                            <div class="add-cart-btn w-full text-button-uppercase py-2 text-center rounded-full duration-500 bg-white hover:bg-black hover:text-white">Add To Cart</div>
                                            ...
                                            <div class="product-item grid-type" data-item="5">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        ...
                                                        <div class="product-img w-full h-full aspect-[3/4]">
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/5-1.png') }}" alt="img" />
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/5-2.png') }}" alt="img" />
                                                        </div>
                                                        <div class="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
                                                            <div class="quick-view-btn w-full text-button-uppercase py-2 text-center rounded-full duration-300 bg-white hover:bg-black hover:text-white">Quick View</div>
                                                            <div class="add-cart-btn w-full text-button-uppercase py-2 text-center rounded-full duration-500 bg-white hover:bg-black hover:text-white">Add To Cart</div>
                                            ...
                                            <div class="product-item grid-type" data-item="6">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        ...
                                                        <div class="product-img w-full h-full aspect-[3/4]">
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/6-1.png') }}" alt="img" />
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/6-2.png') }}" alt="img" />
                                                        </div>
                                                        <div class="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
                                                            <div class="quick-view-btn w-full text-button-uppercase py-2 text-center rounded-full duration-300 bg-white hover:bg-black hover:text-white">Quick View</div>
                                                            <div class="add-cart-btn w-full text-button-uppercase py-2 text-center rounded-full duration-500 bg-white hover:bg-black hover:text-white">Add To Cart</div>
                                            ...
                                            <div class="product-item grid-type" data-item="7">
                                                <div class="product-main cursor-pointer block">
                                                    <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                                        ...
                                                        <div class="product-img w-full h-full aspect-[3/4]">
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/7-1.png') }}" alt="img" />
                                                            <img class="w-full h-full object-cover duration-700" src="{{ asset('frontend/images/product/fashion/7-2.png') }}" alt="img" />
                                                        </div>
                                                        <div class="list-action grid grid-cols-2 gap-3 px-5 absolute w-full bottom-5 max-lg:hidden">
                                                            <div class="quick-view-btn w-full text-button-uppercase py-2 text-center rounded-full duration-300 bg-white hover:bg-black hover:text-white">Quick View</div>
                                                            <div class="add-cart-btn w-full text-button-uppercase py-2 text-center rounded-full duration-500 bg-white hover:bg-black hover:text-white">Add To Cart</div>
                ...
                <div class="container">
                        ...
                        <div class="list-img lg:w-3/4 md:w-[70%] lg:pl-[15px] md:pl-[15px]">
                            ...
                            <div class="list md:mt-6 mt-3">
                                <div class="swiper swiper-img-review h-full relative">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/images/product/fashion/8-2.png') }}" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/images/product/fashion/7-2.png') }}" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/images/product/fashion/6-2.png') }}" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/images/product/fashion/5-2.png') }}" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/images/product/fashion/4-2.png') }}" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/images/product/fashion/3-2.png') }}" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/images/product/fashion/2-2.png') }}" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="list-review">
                        <div class="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                            <div class="left lg:w-1/4 w-full lg:pr-[15px]">
                                <div class="list-img-review flex gap-2">
                                    <img src="{{ asset('frontend/images/product/fashion/9-2.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                    <img src="{{ asset('frontend/images/product/fashion/9-3.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                    <img src="{{ asset('frontend/images/product/fashion/9-4.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                </div>
                                <div class="user mt-3">
                        ...
                        <div class="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                            <div class="left lg:w-1/4 w-full lg:pr-[15px]">
                                <div class="list-img-review flex gap-2">
                                    <img src="{{ asset('frontend/images/product/fashion/5-2.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                    <img src="{{ asset('frontend/images/product/fashion/5-1.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                    <img src="{{ asset('frontend/images/product/fashion/5-3.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                </div>
                                <div class="user mt-3">
                                    <div class="text-title">Tony Nguyen</div>
                                    <div class="flex items-center gap-2">
                        ...
                        <div class="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                            <div class="left lg:w-1/4 w-full lg:pr-[15px]">
                                <div class="list-img-review flex gap-2">
                                    <img src="{{ asset('frontend/images/product/fashion/22-2.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                    <img src="{{ asset('frontend/images/product/fashion/22-1.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                    <img src="{{ asset('frontend/images/product/fashion/22-3.png') }}" alt="img" class="w-[60px] aspect-square rounded-lg" />
                                </div>
                                <div class="user mt-3">
                                    <div class="text-title">Tony Nguyen</div>
                                    <div class="flex items-center gap-2">
