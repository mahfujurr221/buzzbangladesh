                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="shop-breadcrumb1.html" class="collection-item block relative rounded-2xl overflow-hidden cursor-pointer">
                                <div class="bg-img">
                                    <img src="https://placehold.co/400x500/f0f0f0/999999?text=Collection" alt="swimwear" />
                                </div>
                        ...
                        <div class="swiper-slide">
                            <a href="shop-breadcrumb1.html" class="collection-item block relative rounded-2xl overflow-hidden cursor-pointer">
                                <div class="bg-img">
                                    <img src="https://placehold.co/400x500/f0f0f0/999999?text=Collection" alt="top" />
                                </div>
                        ...
                        <div class="swiper-slide">
                            <a href="shop-breadcrumb1.html" class="collection-item block relative rounded-2xl overflow-hidden cursor-pointer">
                                <div class="bg-img">
                                    <img src="https://placehold.co/400x500/f0f0f0/999999?text=Collection" alt="sets" />
                                </div>
                        ...
                        <div class="swiper-slide">
                            <a href="shop-breadcrumb1.html" class="collection-item block relative rounded-2xl overflow-hidden cursor-pointer">
                                <div class="bg-img">
                                    <img src="https://placehold.co/400x500/f0f0f0/999999?text=Collection" alt="outerwear" />
                                </div>
                        ...
                        <div class="swiper-slide">
                            <a href="shop-breadcrumb1.html" class="collection-item block relative rounded-2xl overflow-hidden cursor-pointer">
                                <div class="bg-img">
                                    <img src="https://placehold.co/400x500/f0f0f0/999999?text=Collection" alt="underwear" />
                                </div>
                        ...
                        <div class="swiper-slide">
                            <a href="shop-breadcrumb1.html" class="collection-item block relative rounded-2xl overflow-hidden cursor-pointer">
                                <div class="bg-img">
                                    <img src="https://placehold.co/400x500/f0f0f0/999999?text=Collection" alt="t-shirt" />
                                </div>
        ...
        <div class="banner-block style-one grid sm:grid-cols-2 gap-5 md:pt-20 pt-10">
            <a href="shop-breadcrumb-img.html" class="banner-item relative block overflow-hidden duration-500">
                <div class="banner-img">
                    <img src="https://placehold.co/600x400/e8e8e8/aaaaaa?text=Banner" class="duration-1000" alt="img" />
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="https://www.instagram.com/" target="_blank" class="item relative block rounded-[32px] overflow-hidden">
                                    <img src="https://placehold.co/200x200/f5f5f5/aaaaaa?text=Image" alt="0" class="h-full w-full duration-500 relative" />
                            ...
                            <div class="swiper-slide">
                                <a href="https://www.instagram.com/" target="_blank" class="item relative block rounded-[32px] overflow-hidden">
                                    <img src="https://placehold.co/200x200/f5f5f5/aaaaaa?text=Image" alt="1" class="h-full w-full duration-500 relative" />
                                    <div class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                        <div class="icon-instagram text-2xl text-black"></div>
                                    </div>
                                </a>
                            ...
                            <div class="swiper-slide">
                                <a href="https://www.instagram.com/" target="_blank" class="item relative block rounded-[32px] overflow-hidden">
                                    <img src="https://placehold.co/200x200/f5f5f5/aaaaaa?text=Image" alt="2" class="h-full w-full duration-500 relative" />
                                    <div class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                        <div class="icon-instagram text-2xl text-black"></div>
                                    </div>
                                </a>
                            ...
                            <div class="swiper-slide">
                                <a href="https://www.instagram.com/" target="_blank" class="item relative block rounded-[32px] overflow-hidden">
                                    <img src="https://placehold.co/200x200/f5f5f5/aaaaaa?text=Image" alt="3" class="h-full w-full duration-500 relative" />
                                    <div class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                        <div class="icon-instagram text-2xl text-black"></div>
                                    </div>
                                </a>
                            ...
                            <div class="swiper-slide">
                                <a href="https://www.instagram.com/" target="_blank" class="item relative block rounded-[32px] overflow-hidden">
                                    <img src="https://placehold.co/200x200/f5f5f5/aaaaaa?text=Image" alt="4" class="h-full w-full duration-500 relative" />
                                    <div class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                        <div class="icon-instagram text-2xl text-black"></div>
                                    </div>
                                </a>
                            ...
                            <div class="swiper-slide">
                                <a href="https://www.instagram.com/" target="_blank" class="item relative block rounded-[32px] overflow-hidden">
                                    <img src="https://placehold.co/200x200/f5f5f5/aaaaaa?text=Image" alt="5" class="h-full w-full duration-500 relative" />
                                    <div class="icon w-12 h-12 bg-white hover:bg-black duration-500 flex items-center justify-center rounded-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1]">
                                        <div class="icon-instagram text-2xl text-black"></div>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item relative flex items-center justify-center h-[36px]">
                                    <img src="https://placehold.co/120x60/ffffff/cccccc?text=Brand" alt="1" class="h-full w-auto duration-500 relative object-cover" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item relative flex items-center justify-center h-[36px]">
                                    <img src="https://placehold.co/120x60/ffffff/cccccc?text=Brand" alt="2" class="h-full w-auto duration-500 relative object-cover" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item relative flex items-center justify-center h-[36px]">
                                    <img src="https://placehold.co/120x60/ffffff/cccccc?text=Brand" alt="3" class="h-full w-auto duration-500 relative object-cover" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item relative flex items-center justify-center h-[36px]">
                                    <img src="https://placehold.co/120x60/ffffff/cccccc?text=Brand" alt="4" class="h-full w-auto duration-500 relative object-cover" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item relative flex items-center justify-center h-[36px]">
                                    <img src="https://placehold.co/120x60/ffffff/cccccc?text=Brand" alt="5" class="h-full w-auto duration-500 relative object-cover" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item relative flex items-center justify-center h-[36px]">
                                    <img src="https://placehold.co/120x60/ffffff/cccccc?text=Brand" alt="6" class="h-full w-auto duration-500 relative object-cover" />
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item relative flex items-center justify-center h-[36px]">
                                    <img src="https://placehold.co/120x60/ffffff/cccccc?text=Brand" alt="7" class="h-full w-auto duration-500 relative object-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="list overflow-x-auto sm:pr-6">
                                <div class="product-item item pb-5 flex items-center justify-between gap-3 border-b border-line" data-item="1">
                                    <div class="infor flex items-center gap-5">
                                        <div class="bg-img">
                                            <img src="https://placehold.co/300x400/f5f5f5/999999?text=Product" alt="img" class="w-[100px] aspect-square flex-shrink-0 rounded-lg" />
                                        </div>
                                        <div class="">
                            ...
                            <div class="product-main cursor-pointer block">
                                <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                    ...
                                    <div class="product-img w-full h-full aspect-[3/4]">
                                        <img class="w-full h-full object-cover duration-700" src="https://placehold.co/300x400/f5f5f5/999999?text=Product" alt="img" />
                                        <img class="w-full h-full object-cover duration-700" src="https://placehold.co/300x400/f5f5f5/999999?text=Product" alt="img" />
                                    </div>
                    ...
                    <div class="left lg:w-[388px] md:w-[300px] flex-shrink-0 px-6">
                        <div class="list-img max-md:flex items-center gap-4">
                            <div class="bg-img w-full aspect-[3/4] max-md:w-[150px] max-md:flex-shrink-0 rounded-[20px] overflow-hidden md:mt-6">
                                <img src="https://placehold.co/300x400/f5f5f5/999999?text=Product" alt="item" class="w-full h-full object-cover" />
                            </div>
                            <div class="bg-img w-full aspect-[3/4] max-md:w-[150px] max-md:flex-shrink-0 rounded-[20px] overflow-hidden md:mt-6">
                                <img src="https://placehold.co/300x400/f5f5f5/999999?text=Product" alt="item" class="w-full h-full object-cover" />
                            </div>
                                ...
                                <div class="choose-color">
                                    ...
                                    <div class="list-color flex items-center gap-2 flex-wrap mt-3">
                                        <div class="color-item w-12 h-12 rounded-xl duration-300 relative active">
                                            <img src="https://placehold.co/300x400/f5f5f5/999999?text=Product" alt="color" class="rounded-xl" />
                                ...
                                <div class="main-content lg:pt-8 pt-6 lg:pb-6 pb-4 sm:px-4 px-3 border border-line rounded-xl relative max-md:w-2/3 max-sm:w-full">
                                    ...
                                    <div class="list grid grid-cols-6">
                                        <div class="item flex items-center justify-center lg:px-3 px-1">
                                            <img src="https://placehold.co/60x36/f0f0f0/888888?text=Pay" alt="payment" class="w-full" />
                                        </div>
                                        <div class="item flex items-center justify-center lg:px-3 px-1">
                                            <img src="https://placehold.co/60x36/f0f0f0/888888?text=Pay" alt="payment" class="w-full" />
                                        </div>
