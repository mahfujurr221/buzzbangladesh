                    ...
                    <div class="content-footer md:py-[60px] py-10 flex justify-between flex-wrap gap-y-8">
                        <div class="company-infor basis-1/4 max-lg:basis-full pr-7">
                            <a href="{{ route('frontend.home') }}" class="logo inline-block">
                                @if($setting?->logo)
                                    <img src="{{ storage_asset($setting?->logo, 'frontend/assets/images/logo.png') }}" alt="{{ $setting?->site_name ?? 'Logo' }}" class="h-10 md:h-12 lg:h-14 w-auto max-w-[150px] md:max-w-[240px] object-contain object-left">
                                @else
