    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4">
            ...
            <x-modern.card title="Base Pricing" class="mb-4">
                ...
                <div class="mb-3">
                    <x-modern.input label="Initial Stock Quantity" name="stock_quantity" type="number" value="10" min="0" placeholder="e.g. 100" icon="bx bx-package" />
    ...
    <form class="quick-add-form" action="{{ route('colors.store') }}" method="POST" data-target-select="#selected_colors">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="color" class="form-control form-control-color" style="max-width: 60px;" name="code_picker" id="createColorPicker" value="#000000" oninput="document.getElementById('createColorText').value = this.value">
                <input type="text" name="code" id="createColorText" class="form-control" required placeholder="e.g. #FF0000 or red" oninput="document.getElementById('createColorPicker').value = this.value">
            </div>
        </div>
        <div class="form-check form-switch mb-2">
            <input class="form-check-input" type="checkbox" name="active_status" value="1" checked>
