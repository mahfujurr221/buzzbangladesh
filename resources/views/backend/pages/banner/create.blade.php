...
<div class="row">
    <div class="col-xl-8 col-lg-10 mx-auto">
        <x-modern.card title="Create Banner" icon="bx bx-plus-circle">
            <x-slot name="actions">
            ...
            <form action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3">
                        <x-modern.input label="Banner Title" name="title" placeholder="Enter banner title" :value="old('title')" icon="bx bx-text" />
                        <small class="text-muted mt-1 d-block">Optional: A catchy heading for the banner.</small>
                    </div>

                    <div class="col-md-6 mb-3">
                        <x-modern.input label="Subtitle" name="subtitle" placeholder="Enter banner subtitle" :value="old('subtitle')" icon="bx bx-text" />
                    </div>

                    <div class="col-md-6 mb-3">
                        <x-modern.input label="Button Text" name="button_text" placeholder="e.g. Shop Now" :value="old('button_text')" icon="bx bx-pointer" />
                        <small class="text-muted mt-1 d-block">Optional: Text displayed on the banner button.</small>
                    </div>

                    <div class="col-md-6 mb-3">
                        <x-modern.input label="Button Link (URL)" name="button_link" placeholder="https://example.com/promo" :value="old('button_link')" icon="bx bx-link" type="url" />
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="file" name="image" class="form-control @error('image') is-invalid @enderror" accept="image/*" required onchange="previewImage(this, 'imagePreview')">
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="mt-3">
                            <img id="imagePreview" src="#" alt="Image Preview" class="img-thumbnail d-none" style="max-height: 200px; width: auto; object-fit: cover;">
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 border-top pt-4">
                    ...
                    <x-modern.actions.button type="submit" actionType="save" label="Create Banner" icon="bx bx-check" />
                </div>
            </form>
        </x-modern.card>
    </div>
