...
@section('title', 'Sales (Completed Orders)')

@section('content')

@can('list-sale-order')
<x-modern.filter title="Filter Sales" icon="bx bx-search-alt" :resetUrl="route('orders.sales')"
...
<x-modern.card title="Sales Overview" icon="bx bx-check-shield">
