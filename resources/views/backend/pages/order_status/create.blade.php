...
@section('title', 'Add New Order Status')

@section('content')
<div class="row">
    <div class="col-12 col-md-8 mx-auto">
        <x-modern.card title="Create Order Status" icon="bx bx-plus-circle">
            <x-slot name="actions">
            ...
            <form action="{{ route('order-statuses.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <x-modern.input label="Status Name" name="name" placeholder="e.g. Processing, Shipped, Delivered" required icon="bx bx-tag" />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <input type="color" class="form-control form-control-color border-0 p-1" style="width: 50px; height: 45px; border-radius: 10px; cursor: pointer;" id="colorPicker" value="#629D23" title="Choose your color">
                        <div class="flex-grow-1">
                            <x-modern.input name="color_code" id="colorCodeInput" value="#629D23" placeholder="#000000" required containerClass="mb-0" />
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-end">
                    <x-modern.actions.button type="submit" actionType="save" size="lg" />
                </div>
            </form>
        </x-modern.card>
    </div>
