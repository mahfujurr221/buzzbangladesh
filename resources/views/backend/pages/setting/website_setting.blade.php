                                            ...
                                            <div class="p-3 rounded-4 border-2 border-dashed border-light-subtle bg-light">
                                                ...
                                                <div
                                                    ...
                                                    <img id="favicon-preview"
                                                        ...
                                                        onerror="this.src='{{ asset('backend/images/favicon.ico') }}'"
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            document.getElementById('english-font-logo-input').onchange = function (evt) {
                const [file] = this.files;
                if (file) {
            ...
            document.getElementById('bangla-font-logo-input').onchange = function (evt) {
                const [file] = this.files;
                if (file) {
