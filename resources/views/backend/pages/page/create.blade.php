            ...
            <form action="{{ route('pages.store') }}" method="POST">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <textarea name="content" class="form-control summernote @error('content') is-invalid @enderror" rows="12" placeholder="Write the content of your page here...">{{ old('content') }}</textarea>
                        @error('content')
