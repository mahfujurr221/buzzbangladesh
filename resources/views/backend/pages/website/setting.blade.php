                    ...
                    <form action="{{ route('settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-start gap-4">
                                    <div class="position-relative">
                                        <img id="logo-preview" src="{{ storage_asset($setting->logo, 'frontend/assets/images/logo.png') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-start gap-4">
                                    <div class="position-relative">
                                        <img id="favicon-preview" src="{{ storage_asset($setting->favicon, 'backend/images/default_favicon.png') }}" 
