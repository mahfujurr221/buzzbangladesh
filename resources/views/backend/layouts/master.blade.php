...
<body>
    <div id="preloader">
        <div class="loader-content">
            <img src="{{ asset(setting()->logo && file_exists(public_path('uploads/' . setting()->logo)) ? 'uploads/' . setting()->logo : 'frontend/assets/img/logo/demo-logo.png') }}" alt="{{ setting()->site_name }}" class="loader-logo">
        </div>
    </div>
